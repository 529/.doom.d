...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Source Han Code JP" :size 20)
      doom-variable-pitch-font (font-spec :family "Source Han Code JP")
      doom-unicode-font (font-spec :family "Source Han Code JP")
      doom-big-font (font-spec :family "Source Han Code JP" :size 22))
;;
